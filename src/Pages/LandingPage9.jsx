        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <button 
                onClick={handleBookClick}
                className="group px-6 sm:px-8 py-3 sm:py-4 bg-purple-600 hover:bg-purple-700 text-white rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg transition-all flex items-center justify-center gap-2 sm:gap-3 shadow-[0_10px_40px_-10px_rgba(168,85,247,0.5)]"
              >
                Start Consultation
